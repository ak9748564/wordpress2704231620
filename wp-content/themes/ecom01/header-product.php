            ...
            <div class="flex item">
                ...
                <div>
                    <ul class="items-center flex text-[14px] text-[#1c1c1c] font-medium">
                        <li class="mx-3">All Category</li>
                        <li class="mx-3">Hot offers</li>
                        <li class="mx-3">Gift boxes</li>
                        <li class="mx-3">Projects</li>
                        <li class="mx-3">Menu item</li>
                        <li class="mx-3">
    ...
    <!-- navbar mobile -->
    <nav class="bg-white px-4 hidden sm:block lg:hidden mobile">
        <div class="flex justify-between items-center h-[60px]">
            <div class="flex items-center">
                <div class="w-[24px] mr-3 cursor-pointer">
            ...
            <div class="flex items-center">
                <div class="mr-3 cursor-pointer">
                    <div class="w-[24px]">
                        <img src="<?php echo get_template_directory_uri(); ?>/images/shopping_cart.png" alt="">
                    </div>
                </div>
    ...
    <!-- navbar mobile -->
    <nav class="bg-white h-[50px] px-4 sm:hidden border-b">
