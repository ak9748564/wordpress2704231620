    ...
    <nav class="bg-white px-6 hidden md:block lg:hidden mobile">
        <div class="flex justify-between items-center h-[60px]">
            <div class="flex items-center">
                <div class="w-[24px] mr-3 cursor-pointer"><img src="images/menu.png" alt="" class="w-full"></div>
    ...
    <!-- navbar mobile -->
    <div class="px-4 md:hidden bg-white border-b">
        <div class="flex items-center h-[50px]">
            <img src="<?php echo get_template_directory_uri(); ?>/images/left-arrow.png" alt="" class="h-[16px]">
            <p class="text-[15px] text-[#1c1c1c] ml-3 font-medium">Shopping cart</p>
        </div>
    </div>