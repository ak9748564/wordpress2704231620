        ...
        <div class="max-w-[1200px] m-auto py-10 lg:flex ">
            <div class="lg:w-[220px] grow-0 shrink-0 lg:mr-12 flex justify-center">
                ...
                <div class="flex items-center">
                    <a href="index.html">
                        <div class="w-[40px] h-[40px] mr-2 hover:transition-all hover:scale-110 cursor-pointer">
                ...
                <div class="flex items-center mt-5">
                    <div class="h-[36px] w-[36px] flex rounded-full items-center justify-center bg-[#bdc4cd] mx-1 hover:bg-[#3D8BFD] cursor-pointer hover:transition-all hover:scale-125">
                ...
                <div class="sm:flex grow shrink">
                    <div class="flex sm:w-1/2 justify-evenly sm:justify-around">
                        <div class="basis-0">
                            ...
                            <p class="text-[14px] text-[#8b96a5] hover:text-[#1c1c1c] cursor-pointer">About Us</p>
                            <p class="text-[14px] text-[#8b96a5] hover:text-[#1c1c1c] cursor-pointer">Find Store</p>
                            <p class="text-[14px] text-[#8b96a5] hover:text-[#1c1c1c] cursor-pointer">Categories</p>
                            <p class="text-[14px] text-[#8b96a5] hover:text-[#1c1c1c] cursor-pointer">Blogs</p>
                        </div>
                        <div class="basis-0">
                    ...
                    <div class="flex sm:w-1/2 mt-10 sm:mt-0 justify-evenly sm:justify-around">
                        <div class="basis-0 min-w-[96px]">
                            <p class="text-[#1c1c1c] font-medium text-[15px] mb-2">Information</p>
                            <p class="text-[14px] text-[#8b96a5] hover:text-[#1c1c1c] cursor-pointer">Help Center</p>
                            <p class="text-[14px] text-[#8b96a5] hover:text-[#1c1c1c] cursor-pointer">Money Refund</p>
                            <p class="text-[14px] text-[#8b96a5] hover:text-[#1c1c1c] cursor-pointer">Shipping</p>
                            <p class="text-[14px] text-[#8b96a5] hover:text-[#1c1c1c] cursor-pointer">Contact us</p>
                        </div>
                        <div class="basis-0 min-w-[85px]">
                            <p class="text-[#1c1c1c] font-medium text-[15px] mb-2">For users</p>
                            <p class="text-[14px] text-[#8b96a5] hover:text-[#1c1c1c] cursor-pointer">Login</p>
                            <p class="text-[14px] text-[#8b96a5] hover:text-[#1c1c1c] cursor-pointer">Register</p>
                            <p class="text-[14px] text-[#8b96a5] hover:text-[#1c1c1c] cursor-pointer">Settings</p>
                            <p class="text-[14px] text-[#8b96a5] hover:text-[#1c1c1c] cursor-pointer">My orders</p>
                        </div>
                    </div>
                </div>
